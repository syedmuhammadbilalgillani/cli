...
interface DesignProps {
  search?: boolean;
  image?: string; // Typo fixed: "iamge" -> "image"
  children?: ReactNode;
  center?: boolean;
}
...
const Design: React.FC<DesignProps> = ({
  ...
  return (
    <div className="z-40">
      <div className="relative w-full h-full md:min-h-[90dvh] max-h-[70dvh] ">
        {/* Background Image */}
        {image && (
          <Image
            src={image}
        ...
        {/* SVG Waves */}
        <svg
          className="absolute z-30 -bottom-[1px] w-full"
        ...
        {/* Main Content */}
        <div className="relative z-[60] h-full flex flex-col">
          <div
            className={`flex w-full h-full ${search ? "mt-[10%]" : "mt-[2%]"} ${
              center
